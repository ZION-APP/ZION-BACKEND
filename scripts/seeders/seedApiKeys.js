...
async function seedApiKeys() {
  try {
    ...
    const tokens = ['768918d37137f61bd113cbbe3e0ce8db0914d77922d456752e09020c1909d08e', 
    ...
    debug(chalk.green(`${promisesAdmin.length} scopes have been created succesfully for the admin user`));
    debug(chalk.green(`${promisesPublic.length} scopes have been created succesfully for the public user`));
